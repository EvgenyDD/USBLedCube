...
QT_MOC_LITERAL(4, 30, 9)
    ...
    "USBHID\0HIDStateChanged\0\0state\0updateHID"
};
...
void USBHID::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->HIDStateChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->updateHID(); break;
        default: ;
        }
        ...
        {
            typedef void (USBHID::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&USBHID::HIDStateChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject USBHID::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_USBHID.data,
      qt_meta_data_USBHID,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void USBHID::HIDStateChanged(bool _t1)
{
